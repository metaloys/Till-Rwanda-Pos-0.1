...
export default function PointOfSale({ shopId, profile, userRole }: PointOfSaleProps) {
  ...
  return (
    <div className="relative grid grid-cols-1 md:grid-cols-12 gap-6 h-[calc(100vh-9rem)]">
      <div className="md:col-span-7 h-full overflow-y-auto rounded-2xl bg-white dark:bg-slate-800 p-4 shadow-card order-2 md:order-1">
      ...
      <div className="md:col-span-5 flex flex-col rounded-2xl bg-white dark:bg-slate-800 p-4 shadow-card order-1 md:order-2 md:h-full">
