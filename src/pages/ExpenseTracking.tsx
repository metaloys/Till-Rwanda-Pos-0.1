...
import { ReceiptText, Upload, Repeat2, Calendar, Tag } from 'lucide-react'; // Removed DollarSign
                ...
                <div key={expense.id} className="rounded-lg border bg-white p-4 shadow-sm">
                  ...
                  <div className="mt-2 space-y-1.5 text-sm text-gray-600">
                    ...
                    <div className="flex items-center">
                      {expense.is_recurring ? (<div className="flex items-center font-medium text-purple-700"><Repeat2 className="mr-2 h-4 w-4" /> <span className="capitalize">{expense.recurrence_interval}</span></div>) : (<span className="text-gray-500">One-time expense</span>)}
                    </div>
                  </div>
