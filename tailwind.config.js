...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Brand Colors - Sophisticated, not generic
        brand: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Success - Modern green with depth
        success: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        // Warning - Rich amber (not harsh yellow)
        warning: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
          300: '#fcd34d',
          400: '#fbbf24',
          500: '#f59e0b', // Main warning color (MoMo)
          600: '#d97706',
          700: '#b45309',
          800: '#92400e',
          900: '#78350f',
      ...
      boxShadow: {
        ...
        'card-hover': '0 10px 30px -5px rgb(0 0 0 / 0.15), 0 4px 6px -2px rgb(0 0 0 / 0.05)',
